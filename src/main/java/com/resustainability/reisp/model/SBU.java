...
public class SBU {
	...
	private String id	,transaction_no,vehicle_no,user_ip,company_code,date,company_name,project,TransactionNo,VehicleNo,repulled,PTC_status,PTCDT,MSG	,sbu_code	,sbu_name,status,from_date,user_id,password,
