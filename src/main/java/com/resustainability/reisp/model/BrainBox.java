...
public class BrainBox {
	...
	private String Date_And_TimeIn;
	private String Date_And_TimeOut;
	...
	public BrainBox(String transactionNo1, String transactionNo2, String vehicleNo, String typeofMaterial,
			String dateIn, String date_And_TimeIn, String date_And_TimeOut, String timeIN, String dateOUT,
			String timeOUT, String gROSSWeight, String tareWeight, String netWeight, String zone, String transporter,
			String transferstation, String cONTAINERID, Map<String, Object> otherProperties) {
		super();
		...
		DateIn = dateIn;
		Date_And_TimeIn = date_And_TimeIn;
		Date_And_TimeOut = date_And_TimeOut;
		TimeIN = timeIN;
		DateOUT = dateOUT;
		TimeOUT = timeOUT;
	...
	public String getDate_And_TimeIn() {
		return Date_And_TimeIn;
	}

	public void setDate_And_TimeIn(String date_And_TimeIn) {
		Date_And_TimeIn = date_And_TimeIn;
	}

	public String getDate_And_TimeOut() {
		return Date_And_TimeOut;
	}

	public void setDate_And_TimeOut(String date_And_TimeOut) {
		Date_And_TimeOut = date_And_TimeOut;
	}
	...
	public String toString() {
		return "BrainBox [TransactionNo1=" + TransactionNo1 + ", TransactionNo2=" + TransactionNo2 + ", VehicleNo="
				+ VehicleNo + ", TypeofMaterial=" + TypeofMaterial + ", DateIn=" + DateIn + ", Date_And_TimeIn="
				+ Date_And_TimeIn + ", Date_And_TimeOut=" + Date_And_TimeOut + ", TimeIN=" + TimeIN + ", DateOUT="
				+ DateOUT + ", TimeOUT=" + TimeOUT + ", GROSSWeight=" + GROSSWeight + ", TareWeight=" + TareWeight
				+ ", NetWeight=" + NetWeight + ", Zone=" + Zone + ", Transporter=" + Transporter + ", Transferstation="
				+ Transferstation + ", CONTAINERID=" + CONTAINERID + ", otherProperties=" + otherProperties + "]";
	}
